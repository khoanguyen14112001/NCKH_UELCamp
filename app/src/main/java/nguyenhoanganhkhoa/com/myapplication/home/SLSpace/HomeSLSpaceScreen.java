...
public class HomeSLSpaceScreen extends AppCompatActivity {
    ...
    private static List<Comments> getListComment2() {
        ...
        Comments comment3 =new Comments(R.drawable.img_avatar_female,"Anh Khoa",
                "21 Oct 1999, 10:07",4,
                comment_demo,null);
    ...
    public static List<Comments> getListComment1(){
        List<Comments> list = new ArrayList<>();
        Comments comment1 = new Comments(R.drawable.img_heo,"Khoa Nguyễn",
                "21 Oct 2022, 10:07",4,
                comment_demo,getListImagesComment1());
        comment1.setGoodValue(true);
        comment1.setGoodProduct(true);

        Comments comment2 = new Comments(R.drawable.img_avatar_male,"Trương Ý",
                "21 Oct 2021, 10:07",3,
        ...
        Comments comment3 =new Comments(R.drawable.img_avatar_female,"Võ Trinh",
                "21 Oct 1999, 10:07",1,
                comment_demo,null);
        comment3.setGoodSeller(true);

        Comments comment4 =new Comments(R.drawable.img_avatar_male,"Tuyết Ý",
                "21 Oct 2133, 10:07",5,
