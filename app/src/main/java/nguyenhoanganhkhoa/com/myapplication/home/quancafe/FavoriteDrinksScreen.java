...
public class FavoriteDrinksScreen extends AppCompatActivity {
    ...
    private List<Drink> getListDrinkFavorite(){
        List<Drink> listAll = HomeSLSpaceScreen.getListDrink();
    ...
    private void setActionDelete(){
        if(adapter.getItemCount() !=0){
            CustomDialogTwoButtonNew dialog = new CustomDialogTwoButtonNew(FavoriteDrinksScreen.this);
            ...
            Toast.makeText(FavoriteDrinksScreen.this, "There is no product to delete!", Toast.LENGTH_SHORT).show();
        }
    }
